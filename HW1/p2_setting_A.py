...
best_val_accuracy = 0.0  # Initialize the best validation mIOU
...
while epoch < epochs:
    ...
    if val_accuracy > best_val_accuracy:
        ...
        checkpoint_path = os.path.join('./model_checkpoint', f'P2_setting_A_epoch_{epoch}.pth')
