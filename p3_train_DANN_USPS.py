...
target_folder = './hw2_data/digits/usps/data'
train_target_csv_file = './hw2_data/digits/usps/train.csv'
valid_target_csv_file = './hw2_data/digits/usps/val.csv'
...
while epoch < epochs:
    ...
    if val_accuracy > best_val_accuracy:
        ...
        checkpoint_path = os.path.join('./model_checkpoint', f'best_DANN_USPS_{epoch}.pth')
        ...
        checkpoint_path = os.path.join('./model_checkpoint', f'DANN_USPS_{epoch}.pth')
        torch.save(checkpoint, checkpoint_path)
    epoch+=1