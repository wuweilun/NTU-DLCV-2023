...
if __name__ == '__main__':
	...
	for i in range(10):
		...
		print(f'Accuracy of class {i}: {accuracy:.2f}% (correct/total = {class_correct[i]}/{class_total[i]})')

	print('Total accuracy = {} (correct/total = {}/{})'.format(float(correct)/total, correct, total))