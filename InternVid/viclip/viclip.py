...
class ViCLIP(nn.Module):
    ...
    def __init__(self,  tokenizer=None, pretrain=os.path.join(os.path.dirname(os.path.abspath(__file__)), "ViClip-InternVid-10M-FLT.pth"), freeze_text=True, input_num_frames=8):
        ...
        self.video_input_num_frames = input_num_frames
    ...
    def get_predict_label(self, clip_feature, text_feats_tensor, top=5):
        ...
        print("text_feats_tensor:", text_feats_tensor.shape)
